...
public class UserResponse {
  ...
  public UserResponse jobLevel(String jobLevel) {
  ...
  public UserResponse securityGrade(Integer securityGrade) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userResponse.id) &&
        ...
        equalsNullable(this.department, userResponse.department) &&
        equalsNullable(this.jobLevel, userResponse.jobLevel) &&
        Objects.equals(this.securityGrade, userResponse.securityGrade) &&
