...
public class ListRoles200Response {
  ...
  @Valid
  private List<@Valid RoleResponse> data = new ArrayList<>();

  public ListRoles200Response success(Boolean success) {
  ...
  public ListRoles200Response message(String message) {
  ...
  public ListRoles200Response data(List<@Valid RoleResponse> data) {
    this.data = data;
    return this;
  }

  public ListRoles200Response addDataItem(RoleResponse dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty("data")
  public List<@Valid RoleResponse> getData() {
    return data;
  }

  public void setData(List<@Valid RoleResponse> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, listRoles200Response.success) &&
        equalsNullable(this.message, listRoles200Response.message) &&
        Objects.equals(this.data, listRoles200Response.data);
  }
