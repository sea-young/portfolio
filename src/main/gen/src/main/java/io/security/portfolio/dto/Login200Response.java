...
import io.security.portfolio.dto.TokenResponse;
...
public class Login200Response {
  ...
  public Login200Response success(Boolean success) {
  ...
  public Login200Response message(String message) {
  ...
  public Login200Response data(TokenResponse data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, login200Response.success) &&
        equalsNullable(this.message, login200Response.message) &&
        Objects.equals(this.data, login200Response.data);
  }
