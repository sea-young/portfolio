...
public class RoleResponse {
  ...
  public RoleResponse id(Long id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * 예: SYSTEM_ADMIN, ORG_ADMIN, USER
   * @return name
   */
  
  @Schema(name = "name", description = "예: SYSTEM_ADMIN, ORG_ADMIN, USER", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, roleResponse.id) &&
        ...
        equalsNullable(this.description, roleResponse.description);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(description));
  }
